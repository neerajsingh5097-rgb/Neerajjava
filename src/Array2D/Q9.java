...
//Q.8 WAP replace all even elements by their square of 2D array
public class Q9 {
...
//			yah loop colum k liye he 
	...
	public static void printreplaceByAllEven(int arr[][]) {
		
		System.out.println("replace all even elements by their square of 2D array");
//		yah loop row kw liye he
		for(int i = 0;i<arr.length;i++) {
//			yah loop colum k liye he 
			for(int j = 0;j<arr[i].length;j++) {
